...
class Login:
    def __init__(self, home):
        ...
        Frame_login=Frame(self.home,bg="#002366")
        Frame_login.place(x=540,y=90,height=520,width=460)

        # Login title
        title=Label(Frame_login,text="USER LOGIN",font=("Areal",25,"bold"),fg="white",bg="#002366").place(x=150,y=20)
        
        #Username and password lable
        lbl_user=Label(Frame_login,text="Username",font=("Areal",15,"bold"),fg="white",bg="#002366").place(x=25,y=140)
        self.txt_user=Entry(Frame_login,font=("times new roman",15),bg="white")
        self.txt_user.place(x=25,y=170,width=400,height=35)


        lbl_pass=Label(Frame_login,text="Password",font=("Areal",15,"bold"),fg="white",bg="#002366").place(x=25,y=240)
        self.txt_pass = Entry(Frame_login, font=("times new roman", 15), bg="white", show="*")
        self.txt_pass.place(x=25, y=270, width=400, height=35)

        forget=Button(Frame_login,text="Forget Password?",cursor="hand2",command=self.forget_window,fg="white",bg="#002366",font=("times new roman",15,"bold")).place(x=280,y=335)
        
        #Buttons
        signup=Button(Frame_login,text="Sign Up",cursor="hand2",command=self.register_window,bg="white",fg="#002366",font=("times new roman",10,"bold")).place(x=400,y=460,height=55)

        login=Button(Frame_login,command=self.login_function,text="Login",cursor="hand2",bg="white",fg="#002366",font=("Areal",19,"bold")).place(x=178,y=390,width=100,height=50)

        lbl_create=Label(Frame_login,text="Create an account?",font=("Times New Roman",13,"bold"),fg="white",bg="#002366").place(x=250,y=480)

        #Checkbuttons
        UserType=Label(Frame_login,text="User : ", font=("times new roman", 15, "bold"), bg="#002366",fg="white").place(x=45,y=85)
