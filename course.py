...
class CourseClass:
    ...
    # Buttons
        ...
        self.clear_btn=Button(self.home,text="Go Back",font=("times new roman",15,"bold"),bg="black",fg="white",cursor="hand2",command=self.go_back)
        self.clear_btn.place(x=380,y=470,width=120,height=50)
